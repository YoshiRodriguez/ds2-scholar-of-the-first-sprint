const bossRunbacks = [
	{
		...
		estimatedTime: "01:00",
		difficulty: "Easy",
		requirements: "Open the barred door downstairs to the right.",
	...
	},
	{
		...
		difficulty: "Easy",
		requirements:
			"Defeated the Last Giant and gotten the Soldier Key. Opened the barred door behind the fog wall.",
	...
	},
	{
		...
		requirements:
			"Killed the dragon guarding the bridge to the Cathedral of Blue and have pulled the lever to lower it.",
	...
	},
	{
		...
		requirements:
			"Unpetrified the statue blocking the door to the prison cells building, then opened the door shortcut donwstairs.",
